<div class="content-wrapper">
	 ...
	 <h1>Class Routing<small>preview</small></h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Class Route</li>
      </ol>
    </section>
	 ...
	 <section class="content" id="smaller-teacher">
     	<div class="box box-solid box-info" >
		  <div class="box-header with-border">
		    <h3 class="box-title"><i class="glyphicon glyphicon-pencil"></i> Edit Class Route</h3>
		  ...
		  <div class="box-body">
		    <form action="" method="POST">
				...
				<div class="form-group"> 
				  ...
				  <input type="text" name='year' id='year' placeholder="School Year"  class="class-route-select">
				</div>

				 <a href="/e-records/admin?makerouting" class="btn btn-submit"> Edit Routing</a>
