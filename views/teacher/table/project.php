<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Project Criteria</li>
      </ol>
    </section>
    ...
    <?php if(isset($_GET['delete'])):?>
     ...
     <?php endif; ?>
     <br/>
      <a href="/e-records/teacher/add-project" class="btn btn-submit add-plus"><i class="glyphicon glyphicon-plus"></i> Add Project</a>
		   ...
		   <table class="table"> 
			...
			<tbody>
				<tr>
					...
					<td>03/09/2017</td>
					<td>
						<a href="/e-records/teacher/edit-project" class="btn btn-info">Edit</a>
						<a href="/e-records/teacher/project?delete" class="btn btn-delete">Delete</a>
					</td>
				</tr>
				<tr>
					<td>1</td>
