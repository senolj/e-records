<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Student Quizzes</li>
      </ol>
    </section>
     	...
     	<div class="box box-solid box-info">
		  ...
		  <div class="box-body">
		    <form action="" method="POST">
				...
				<div class="form-group">
					<label for="crv_yearlvl">Quizzes:</label>
			       <select name="crv_yearlvl" id="crv_yearlvl" class="btn btn-default dropdown-toggle class-route-select">
				   	<option selected disabled>Select Quizzes</option>
				   	<option value="">Quiz 1</option>
				   	<option value="">Quiz 2</option>
				   </select>
				</div>

			  <a href="/e-records/teacher/student-quiz?view" class="btn btn-submit"> View Students</a>
		    </form>
		  </div>
    ...
    <section class="content">
		<div class="box  box-info">
		 <div class="box-header ">
	        ...
	        <br>
	        <br>
	         <h3 class="box-title"><span style="font-weight:bold;">Quiz:</span>Quiz Name</h3>
	        <br>
	        <br>
	         <h3 class="box-title"><span style="font-weight:bold;">Total Score:</span> 100</h3>
