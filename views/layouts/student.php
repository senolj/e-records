...
<div class="wrapper ">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="/e-records/student/" class="logo">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          ...
          <i class="fa fa-th-list"></i><span>Exam</span></a>
        </li>
        <li>
          <a href="<?php echo base_url("student/project");?>">
          <i class="fa fa-th-list "></i> <span>Project</span></a>
        </li>
        <li>
          <a href="<?php echo base_url("student/quiz");?>">
          <i class="fa fa-th-list"></i> <span>Quizzes</span></a>
        </li>
        <li>
          <a href="<?php echo base_url("student/grades");?>">
          <i class="fa fa-th-list"></i> <span>Grades</span></a>
        </li>  
