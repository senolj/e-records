<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Student Projects</li>
      </ol>
    </section>
     	...
     	<div class="box box-solid box-info">
		  ...
		  <div class="box-body">
		    <form action="" method="POST">
				...
				<div class="form-group">
					<label for="crv_yearlvl">Projects:</label>
			       <select name="crv_yearlvl" id="crv_yearlvl" class="btn btn-default dropdown-toggle class-route-select">
			  ...
			  <a href="/e-records/teacher/student-project?view" class="btn btn-submit"> View Students</a>
		    </form>
		  </div>
    ...
    <section class="content">
		<div class="box  box-info">
		 <div class="box-header ">
	        ...
	        <br>
	        <br>
	         <h3 class="box-title"><span style="font-weight:bold;">Project:</span> Project Name</h3>
	        <br>
	        <br>
